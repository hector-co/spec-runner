...
- [x] 1.1 Add `ITasksFileReader` to `SpecRunner.Core/Abstractions/` with
...
- [x] 3.1 In `ProposeWorkflowRunner.ProcessCommentAsync`, after the CLI
...
- [x] 3.2 Update `ProposeWorkflowRunnerTests` to assert the created draft
...
- [x] 4.1 In `ImplementWorkflowRunner`, after the existing commit+push,
...
- [x] 4.2 Update `ImplementWorkflowRunnerTests` to assert
...
- [x] 5.1 In `FinalizeWorkflowRunner`, after the existing commit+push and
...
- [x] 5.2 Update `FinalizeWorkflowRunnerTests` to assert
...
- [x] 6.1 Run `openspec validate update-pr-content-through-workflow-steps --type change`
      and confirm it passes.
- [x] 6.2 After implementation and tests are green, sync the delta specs
