...
public class UpdateWorkflowRunnerTests : IDisposable
{
    ...
    private (UpdateWorkflowRunner Runner, RecordingGitService Git, RecordingGitHubService GitHub, FakeCliAgentSessionFactory CliFactory, SqliteStateStore StateStore, FakeTasksFileReader TasksFileReader) CreateRunner(
        ...
        Func<ICliAgentSession>? sessionFactory = null)
    {
        ...
        var runner = new UpdateWorkflowRunner(gitHub, git, stateStore, cliFactory, tasksFileReader, commandTemplateRenderer, options, NullLogger<UpdateWorkflowRunner>.Instance);
