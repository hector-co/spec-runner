...
public class ProposeWorkflowRunnerTests : IDisposable
{
    ...
    public async Task SuccessfulRunCommitsPushesCreatesDraftPrAndUpdatesState()
    {
        ...
        Assert.Equal(
            $"\"/opsx-propose feat-45-add-login-page{Environment.NewLine}Add Login Page{Environment.NewLine}We need a login page.{Environment.NewLine}{Environment.NewLine}" +
