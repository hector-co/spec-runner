...
public class ImplementWorkflowRunnerTests : IDisposable
{
    ...
    private (ImplementWorkflowRunner Runner, RecordingGitService Git, RecordingGitHubService GitHub, FakeCliAgentSessionFactory CliFactory, SqliteStateStore StateStore) CreateRunner(
        ...
        Func<ICliAgentSession>? sessionFactory = null)
    {
        ...
        var runner = new ImplementWorkflowRunner(gitHub, git, stateStore, cliFactory, options, NullLogger<ImplementWorkflowRunner>.Instance);
